...
library(cowplot)
```
## Ejericio disponible en mi repo: https://github.com/AkramMendez/webinR
...
```{r}
# geom_bar(stat = "count") 
eukaryotes_clean %>% ggplot(data = ., mapping = aes(x=kingdom)) + geom_bar() 
...
### Hacer versión interactiva, etiquetado
```{r}
